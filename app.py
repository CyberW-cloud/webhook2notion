...
def get_client_from_invite(invite):
	...
	try:
		...
		buyer["questions"] = "\n\n".join([job_info["profile"]["op_additional_questions"]["op_additional_question"][-i]["question"] for i in range(len(job_info["profile"]["op_additional_questions"]["op_additional_question"]))])
